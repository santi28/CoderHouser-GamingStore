    ...
    setTimeout(() => {
      ...
      const productos = [
        ...
        { 
          ...
          alt: "Phasmo",
          title: "Phasmophobia",
          price: 170,          description: "La actividad paranormal va en aumento y depende de ti y de tu equipo utilizar todo el equipo de caza de fantasmas a tu disposición para reunir la mayor cantidad de evidencia posible.",
          categories: ['games'],
          stock: 1000
        },
        { 
